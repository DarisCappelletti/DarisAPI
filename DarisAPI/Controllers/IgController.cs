...
{
    public class IgController : ControllerBase
    {
        // GET api/Ig
        public RicercaUtenteIg.Root Get(string utente = null)
        {
            ...
            var listaUtenti = JsonConvert.DeserializeObject<RicercaUtenteIg.Root>(streamJson2);
        ...
        public RicercaFollowersIg.Root Get(int id, int? maxID = null)
        {
            ...
            var listaFollowers = JsonConvert.DeserializeObject<RicercaFollowersIg.Root>(streamJson2);
