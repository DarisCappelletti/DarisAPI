    ...
    public static class ComuniItalianiHelper
    {
        ...
        )
        {
            ...
            using (var mss = new MemoryStream())
            {
                ...
                // Registra un provider di codifica personalizzato per l'encoding 1252
                Encoding.RegisterProvider(CodePagesEncodingProvider.Instance);

                // Leggi il file Excel
                IExcelDataReader excelReader = ExcelReaderFactory.CreateReader(mss, new ExcelReaderConfiguration()
                {
                    // Imposta l'encoding 1252 come predefinito per la lettura
        ...
        public static DettagliIndicePA RicercaEnteIndicePA(string auth_indicePA, string nomeEnte)
        {
            ...
            var ente =
                risultato == null
                ? null
                : JsonConvert.DeserializeObject<RootEnte>(risultato);
        ...
        public static DettagliIndicePA RicercaDettagliEnteIndicePA(string auth_indicePA, string cod_amm)
        {
            ...
            var dettagliEnte = JsonConvert.DeserializeObject<RootIndicePA>(risultato);
        ...
        public static DettagliWikiData RicercaEnteWikiData(string nomeEnte)
        {
            ...
            var data = JsonConvert.DeserializeObject<WikiDataRoot>(streamJson);
        ...
        public static DettagliWikiData RicercaCoordinateEnteWikiData(string id)
        {
            ...
            var data = JsonConvert.DeserializeObject<Root>(streamJson);
            ...
            var stuff = JsonConvert.DeserializeObject<object>(streamJson);
